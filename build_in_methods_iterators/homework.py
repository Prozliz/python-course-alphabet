...
def task_1_fix_names_start_letter(data: DT) -> DT:
    for list_dict in data:
        for key, value in list_dict.items():
            if key == 'name' and value[0] in 'asdfghjjklzxcvbnmqwertyuiop':
                str = value[0].upper() + value[1:]
                list_dict.update(('name', str) for k, v in list_dict.items())
...
def task_11_create_list_of_random_characters() -> List[str]:
    import random
    List = [random.choice(list('qwertyuiopasdfghjklzxcvbnm')) for x in range(20)]
    """
