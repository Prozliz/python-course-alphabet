...
''
    ...
    """
    cur.execute("""SELECT city, COUNT(customername)
        FROM customers 
        GROUP BY city""")
    return cur.fetchall()
...
def task_9_count_customers_by_country_with_than_10_customers(cur):
    ...
    Returns: 3 records
    """
    cur.execute("""SELECT COUNT(customername),country 
        FROM customers 
        GROUP BY country 
...
def task_12_list_suppliers_from_specified_countries(cur):
    ...
    Returns: 8 records
    """
    cur.execute("""SELECT suppliername 
        FROM suppliers 
...
def task_15_list_customers_with_any_order_or_not(cur):
    ...
    Returns: 213 records
    """
    cur.execute("""SELECT orders.orderid, customers.customername, customers.contactname, customers.country
                    FROM customers 
                   LEFT JOIN orders
...
def task_16_match_all_customers_and_suppliers_by_country(cur):
    """
    moreatch all customers and suppliers by country
